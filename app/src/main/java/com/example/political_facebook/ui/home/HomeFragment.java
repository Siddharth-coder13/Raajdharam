package com.example.political_facebook.ui.home;
...
import com.example.political_facebook.Login_public;
import com.example.political_facebook.R;
import com.example.political_facebook.Adapter.postAdapter;
import com.example.political_facebook.model.post;
import com.example.political_facebook.model.userModel;
import com.example.political_facebook.serach_user;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        circleImageView = (CircleImageView) root.findViewById(R.id.user_image);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                post m = new post(mUsername, editText.getText().toString(),null, currentDateAndTime,image_uri,post_id ,FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    for(String id : followingList){
                        if(m.getPublisher().equals(id) || m.getPublisher().equals(mUid)){
                            posts.add(m);}
                    }
                    mrecyclerView.setAdapter(madapter);
    ...
    private void updateUser(){
        Glide.with(HomeFragment.this).load(image_uri).into(circleImageView);
