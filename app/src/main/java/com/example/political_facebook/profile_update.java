...
public class profile_update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String image1 = i.getStringExtra("image");
        ...
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                update_user_info(name.getText().toString(),bio.getText().toString(),designation.getText().toString(),downloadUri.toString(),user.getUid());
            }
        });
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    picref.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            Toast.makeText(profile_update.this, downloadUri.toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
