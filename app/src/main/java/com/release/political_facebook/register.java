    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String image = "https://firebasestorage.googleapis.com/v0/b/political-facebook.appspot.com/o/account.png?alt=media&token=10b610bc-0dd3-4ae6-852b-8812051b8760";
